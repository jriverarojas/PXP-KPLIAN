...
Phx.vista.modalidad=Ext.extend(Phx.gridInterfaz,{
	...
	Atributos:[
		...
		},
		{
			...
			type:'TextField',
			filters:{pfiltro:'modali.nombre',type:'string'},
			id_grupo:1,
			grid:true,
			form:true
		},
	...
	title:'modalidad',
	ActSave:'../../sis_legal/control/Modalidad/insertarModalidad',
	ActDel:'../../sis_legal/control/Modalidad/eliminarModalidad',
	ActList:'../../sis_legal/control/Modalidad/listarModalidad',
