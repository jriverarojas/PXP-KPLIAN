...
Phx.vista.Estacion=Ext.extend(Phx.gridInterfaz,{
	...
	constructor:function(config){
		...
		var combo_pro = new Ext.form.AwesomeCombo(
		{
			...
			store: new Ext.data.JsonStore({
  			url: '../../sis_parametros/control/Proyecto/listarProyecto',
				...
				remoteSort: true,
				baseParams:{par_filtro:'nombre_proyecto',hidro:'si',todos:'si'}
		...
		{	
			...
			if(record.data.nombre_proyecto == 'TODOS')
			{
				combo_pro.collapse();
			}	
		},this);	
	...
	Atributos:[
		...
		{
			config:{
				name: 'id_administrador', //nombre variable
				fieldLabel: 'Administrador', //texto del campo
				allowBlank: false, //permite blancos
				emptyText:'Administrador...', //letra transparente
				store:new Ext.data.JsonStore( //store de datos para el combo
				{
					url: '../../sis_hidrologia/control/AdministradorHidro/listarAdministradorHidro', //listar
					id: 'id_administrador', //nombre variable
					root: 'datos', //
					sortInfo:{
						field: 'nombre',
						direction: 'ASC'
	...
	ActList:'../../sis_hidrologia/control/Estacion/listarProyEstacion',
	...
	preparaMenu:function(tb){
		...
		Phx.vista.Estacion.superclass.preparaMenu.call(this,tb)
		this.getBoton('FotoEstacion').enable();	
	},
	
	liberaMenu:function(tb){
		// llamada funcion clace padre
		Phx.vista.Estacion.superclass.liberaMenu.call(this,tb)
		this.getBoton('FotoEstacion').disable();
