...
?>
<script>
Phx.vista.CajeroCobro=Ext.extend(Phx.gridInterfaz,{

	constructor:function(config){
		this.maestro=config.maestro;
    	//llama al constructor de la clase padre
		Phx.vista.CajeroCobro.superclass.constructor.call(this,config);
		this.init();
	...
	{
		Phx.vista.CajeroCobro.superclass.loadValoresIniciales.call(this);
	...
	south:{
		  url:'../../../sis_cobranza/vista/cobro/CobroCajero.php',
	...
	preparaMenu:function(tb)
	{
			...
			Phx.vista.CajeroCobro.superclass.preparaMenu.call(this,tb);
