...
/**
*@package pXP
*@file gen-SistemaDistAgenciaEnt.php
*@author  (gvelasquez)
...
?>
<script>
Phx.vista.SistemaDistAgenciaEnt=Ext.extend(Phx.gridInterfaz,{

	constructor:function(config){
		
		this.maestro=config;
    	//llama al constructor de la clase padre
		Phx.vista.SistemaDistAgenciaEnt.superclass.constructor.call(this,config);
		this.init()
	  ...
	  //onEnablePanel al para cargar los datos del padre
	   if(Phx.CP.getPagina(this.idContenedorPadre)){
		...
		//this.load({params:{start:0, limit:50, id_agencia:this.maestro.id_agencia}});
	},
	...
	Atributos:[
		...
		},
		{
			config:{
				...
				fieldLabel: 'Sistema de Distribucion',
				allowBlank: false,
				emptyText:'Sistema e Distribucion...',
				store:new Ext.data.JsonStore(
				{
					...
					totalProperty: 'total',
					fields: ['id_sistema_dist','nombre','codigo'],
			...
			type:'ComboBox',
			filters:{pfiltro:'nombre_sistema',type:'string'},
			id_grupo:1,
			grid:true,
			form:true,
			egrid:true
	...
	{
		Phx.vista.SistemaDistAgenciaEnt.superclass.loadValoresIniciales.call(this);
		this.getComponente('id_agencia').setValue(this.maestro.id_agencia);		
	},
