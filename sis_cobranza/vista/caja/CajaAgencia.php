...
?>
<script>
Phx.vista.CajaAgencia=Ext.extend(Phx.gridInterfaz,{

	constructor:function(config){
		this.maestro=config.maestro;
    	//llama al constructor de la clase padre
		Phx.vista.CajaAgencia.superclass.constructor.call(this,config);
		this.init();	
	...
	{
		Phx.vista.CajaAgencia.superclass.loadValoresIniciales.call(this);
	...
	/*preparaMenu:function(tb)
	{
			...
			Phx.vista.CajaAgencia.superclass.preparaMenu.call(this,tb);
	},*/
	/*iniciarEventos:function(){
		this.getComponente('id_enti_fin').on('select',function(s,r,i){
			alert('evento del combo')
