...
?>
<script>
Phx.vista.RepFacturacionPend=Ext.extend(Phx.frmInterfaz,{
	Atributos:[
	       	{
		       	config:{
	       	...
	       	{
		       	config:{
		       		id: 'fecha_ini_'+this.idContenedor+'_RepFacturacionPend',
		       		name:'fecha_ini',
		       		fieldLabel:'Fecha Inicio',
		       		allowBlank:false,
		       		vtype: 'daterange',
		       		endDateField:'fecha_fin_'+this.idContenedor+'_RepFacturacionPend',
		       		format:'d-m-Y'
	       	...
	       	{
		       	config:{
	       			id: 'fecha_fin_'+this.idContenedor+'_RepFacturacionPend',
		       		name:'fecha_fin',
		       		fieldLabel:'Fecha Fin',
		       		allowBlank:false,
		       		vtype: 'daterange',
		       		startDateField:'fecha_ini_'+this.idContenedor+'_RepFacturacionPend',
		       		format:'d-m-Y'
	       		},
	       		type:'DateField'
	       	}
	],
	title:'Facturación Pendiente de Cobro',
	ActSave:'../../sis_cobranza/control/FacturaCob/repFacturacionPend',
	topBar:true,
	botones:false,
	...
	constructor: function(config){
		Phx.vista.RepFacturacionPend.superclass.constructor.call(this,config);
		this.init();
	},
	tipo:'reporte',
	clsSubmit:'bprint',
